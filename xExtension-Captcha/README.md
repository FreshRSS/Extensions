...
* 1.0.4 [2026-03-11]
	* Fixed wrong path in CSP causing reCAPTCHA to not work properly, regression from v1.0.1 (https://github.com/FreshRSS/Extensions/discussions/434)
* 1.0.3 [2025-12-17]
	* Minor code changes (https://github.com/FreshRSS/Extensions/pull/406)
* 1.0.2 [2025-12-06]
