...
return array(
	'llm_classification' => array(
		'api' => array(
			...
			'allow_thinking' => 'Autoriser le mode raisonnement<br />(si disponible)',
			'allow_thinking_help' => 'Autoriser le mode raisonnement (<i>thinking, reasoning</i>) pour les modèles qui le supportent. Décocher pour désactiver, par ex. pour réduire la longueur de la réponse.',
		),
		'prompts' => array(
			'title' => 'Invites',
